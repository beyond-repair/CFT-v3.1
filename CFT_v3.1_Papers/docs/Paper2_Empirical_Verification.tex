It looks like you have a well-structured LaTeX document for a scientific paper. Below is the clean, formatted version of your text, optimized for readability as a digital document. I have also corrected a few LaTeX syntax nuances (such as using \text for units) and organized the content into a clear, professional layout.
